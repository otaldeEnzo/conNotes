...
```mermaid
graph TD
    A[Configurações do Sistema] --> B[⚙️ Geral, Tags & Atalhos]
    A --> C[🎨 Visual, Temas & Tipografia]
...
### Fase 2: Theme Studio Granular, Tipografia & Presets de Desempenho
...
- Testar editor de atalhos e detecção de conflitos de teclas.
- Testar biblioteca de prompts e galeria de backgrounds nativa.
