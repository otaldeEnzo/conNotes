...
class _CardSlashCommandPopoverState extends State<CardSlashCommandPopover> {
  ...
  static const List<SlashCommandItem> _allCommands = [
    ...
    SlashCommandItem(
      key: 'conceito concept definicao teoria',
      title: 'Callout Conceito / Definição',
      subtitle: 'Conceitos fundamentais com borda esmeralda',
      icon: Icons.menu_book_rounded,
      snippet: '> [!CONCEPT]\n> Definição formal do conceito científico.',
    ),
    SlashCommandItem(
      key: 'teorema theorem formula lei',
    ...
    SlashCommandItem(
      key: 'aviso warning atencao alerta cuidado erro',
    ...
    SlashCommandItem(
      key: 'math formula latex equacao integral',
    ...
    SlashCommandItem(
      key: 'mermaid fluxograma diagrama mapa processo',
    ...
    SlashCommandItem(
      key: 'codigo code python dart cpp rust',
    ...
    SlashCommandItem(
      key: 'tarefas checklist todo afazeres',
      title: 'Lista de Tarefas (Checklist)',
      subtitle: 'Checklist interativa com barra de progresso',
      icon: Icons.check_box_outlined,
      snippet: '- [ ] Primeira Tarefa\n- [ ] Segunda Tarefa',
    ),
    SlashCommandItem(
      key: 'h1 titulo1 titulo grande',
      title: 'Título 1 (H1)',
    ...
    SlashCommandItem(
      key: 'h2 titulo2 subtitulo medio',
      title: 'Título 2 (H2)',
